...
# ----------------------------------------
# If my_ROM is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2021.09.24.15:21:15
...
alias com {
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/my_ROM.v"                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L onchip_flash_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L onchip_flash_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
