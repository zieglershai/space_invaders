...
module altera_onchip_flash_avmm_data_controller (
    ...
    generate // generate combi based on read burst mode
        if (WRAPPING_BURST_MODE == 0) begin
            // incrementing read
            assign flash_read_addr = avmm_addr; // (is_read_busy) ? flash_seq_read_ardin : avmm_addr; KDB EDIT https://www.intel.com/content/www/us/en/programmable/support/support-resources/knowledge-base/solutions/rd10162015_230.html SHAI ZIEGLER
